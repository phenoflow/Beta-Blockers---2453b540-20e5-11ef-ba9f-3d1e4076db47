...
codes = [{"code":"18185","system":"gprdproduct"},{"code":"5713","system":"gprdproduct"},{"code":"19853","system":"gprdproduct"},{"code":"38991","system":"gprdproduct"},{"code":"7091","system":"gprdproduct"}];
REQUIRED_CODES = 1;
